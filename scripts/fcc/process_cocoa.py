...
#     	
#     	
#     	gps_hit = get_particle_feature_matrix(cell_to_gp_all, genp_features, particle_feature_order)
...
#
    	...
    	#this_ev = awkward.Record({"X_track": X_track, "X_hit": X_hit,"ygen_track": ygen_track, "ygen_hit": ygen_hit})
    	this_ev = awkward.Record({"X_track": X_track, "X_hit": X_hit})
    	ret.append(this_ev)
...
def process_sample(samp):
    inp = "/srv01/agrp/annai/annai/NEW_HGFlow/MLPF/inputs_cocoa"
    outp = "/srv01/agrp/annai/annai/NEW_HGFlow/MLPF//outputs_cocoa/"
